...
def complete_payment(request):
    ...
    if order_qs.exists():
        order = order_qs[0]
        order.ordered = True
        order.paymentId = "12345"  # Placeholder, replace with actual payment ID
        order.orderId = "54321"  # Placeholder, replace with actual order ID
        order.save()
        ...
        messages.success(request, 'Your payment was successful and the order is completed!')
    else:
